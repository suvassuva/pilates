          ...
          if (link.label === "Services") {
            ...
            return (
              <div key={link.href} className="space-y-1">
                ...
                {/* Sub-links */}
                <div className="pl-4 pr-1 py-1 space-y-1 border-l-2 border-[#B91C1C]/30 ml-3">
                  <Link
                    href="/services/reformer-pilates"
                    onClick={onClose}
                    className="block px-2.5 py-1.5 text-xs text-[#5A554E] hover:text-[#B91C1C] rounded-md transition-colors"
                  >
                    • Reformer Pilates
                  </Link>
                  <Link
