...
export const WhyChooseUs: React.FC = () => {
  ...
  const features = [
    ...
    {
      icon: <Sliders className="w-5 h-5 text-[#C5A059]" />,
    ...
    {
      icon: <User className="w-5 h-5 text-[#C5A059]" />,
      ...
      <Container>
        ...
        >
          {features.map((feat, idx) => (
            <div
              key={idx}
              className="snap-start shrink-0 w-[82vw] md:w-auto p-4 sm:p-6 rounded-2xl bg-[#1A1D20] border border-[#282C32] hover:border-[#C5A059]/40 shadow-xs hover-lift flex flex-col justify-between"
            >
              <div>
                <div className="w-10 h-10 rounded-xl bg-[#121417] border border-[#C5A059]/30 flex items-center justify-center mb-3">
                  {feat.icon}
                </div>
                <h3 className="text-sm sm:text-base font-bold font-display text-[#FAF8F5] mb-2">
                  {feat.title}
                </h3>
