...
export const TrainersPreview: React.FC = () => {
  ...
  return (
    <section className="py-12 sm:py-20 bg-[#EEEDE8] relative overflow-hidden">
      <Container>
        <SectionTitle
        ...
        >
          {TRAINERS.map((trainer) => (
            <div
              key={trainer.id}
              className="snap-start shrink-0 w-[82vw] md:w-auto bg-[#FFFFFF] rounded-2xl sm:rounded-3xl overflow-hidden border border-[#E5E0D8] shadow-sm hover-lift flex flex-col justify-between"
            >
              <div>
                {/* Trainer Photo */}
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <p className="text-xs text-[#4A4641] mb-3 sm:mb-4 leading-relaxed line-clamp-3">
                    {trainer.bio}
                  </p>

                  <div className="space-y-1 pt-2 border-t border-[#E5E0D8]">
                    <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-[#7A756D]">
                      Specializations
                    </span>
